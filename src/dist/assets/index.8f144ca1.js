...
function qu(e, n, t, r) {
  if (Dr) {
    ...
    else if ((Xo(e, r), n & 4 && -1 < Vc.indexOf(e))) {
      for (; l !== null; ) {
        var u = Gt(l);
        if (
          (u !== null && Ps(u),
...
function Us(e) {
  if (e.propertyName === "value" && nl(It)) {
    var n = [];
    Fs(n, It, e, Xu(e)), ys(kf, n);
  }
}
function Ef(e, n, t) {
  e === "focusin"
    ? (li(), (Ct = n), (It = t), Ct.attachEvent("onpropertychange", Us))
    : e === "focusout" && li();
}
function Cf(e) {
...
var Bs = tl("animationend"),
  Hs = tl("animationiteration"),
  ...
  if (!e[sr]) {
    (e[sr] = !0),
      ns.forEach(function (t) {
        t !== "selectionchange" && (Rf.has(t) || Ol(t, !1, e), Ol(t, !0, e));
      });
...
var vu = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  If =
    typeof queueMicrotask == "function"
      ...
      : typeof di < "u"
      ? function (e) {
          return di.resolve(null).then(e).catch(Ff);
        }
      : vu;
function Ff(e) {
  setTimeout(function () {
...
function mn() {
  if (!Il && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), Ss(Gu, mn), l);
    } finally {
      (O = n), (Il = !1);
    }
  }
...
function Eu(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = ta), fo(e);
  var u = n.contextType;
  typeof u == "object" && u !== null
    ? (l.context = Ce(u))
...
function ja(e) {
  ...
  n !== null && ((e.alternate = null), ja(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[$t], delete n[hu], delete n[jf], delete n[Uf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Yo(t), n === 1))
      e.tag === 0 ? $f($i.bind(null, e)) : Zs($i.bind(null, e)),
        If(function () {
          (R & 6) === 0 && mn();
        }),
        (t = null);
...
Xa = function (e, n, t) {
  ...
  else (ae = !1), j && (n.flags & 1048576) !== 0 && Js(n, Vr, n.index);
...
vs = xo;
hs = zn;
var yd = { usingClientEntryPoint: !1, Events: [Gt, jn, rl, ps, ms, xo] },
  vt = {
...
const zr = Mo.exports.jsx,
  xd = Mo.exports.jsxs,
  Pd = () =>
    xd("div", {
      children: [
        zr("h2", { children: "Hello" }),
        zr("p", { children: "You have changed..." }),
        zr("img", { src: "/SEO.png" }),
      ],
    }),
  Nd = document.getElementById("root");
Wl.createRoot(Nd).render(zr(Pd, {}));
